...
This program is distributed under the GNU General Public License, version 3 or later (GPLv3+).
...
To compile use:
    ...
    gcc capta.c cminpack/covar.c cminpack/enorm.c cminpack/lmder.c cminpack/lmpar.c cminpack/qrfac.c cminpack/qrsolv.c gnuplot_i/gnuplot_i.c iniparser/dictionary.c  iniparser/iniparser.c models/dpwf.c models/dpwfc.c models/dpwfcl.c models/dpwfcpob.c models/dpwff.c models/dpwfnfob.c models/dpwfrect.c models/dpwft.c models/dpwfdp.c models/dpwfdppss.c models/dpwfdptsl.c models/dpwfdptsp.c models/dpwficf.c models/dpwffcf.c models/dpwfle.c stehfest/stehfest.c utils/utils.c -lm -lgsl -I/usr/include/gsl -lgslcblas -o captas
